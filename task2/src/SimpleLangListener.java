...
public interface SimpleLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code VarDeclInitExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 */
	void enterVarDeclInitExpr(SimpleLangParser.VarDeclInitExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code VarDeclInitExpr}
	 * labeled alternative in {@link SimpleLangParser#exp}.
	 * @param ctx the parse tree
	 */
	void exitVarDeclInitExpr(SimpleLangParser.VarDeclInitExprContext ctx);
	/**
