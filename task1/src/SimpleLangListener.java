...
public interface SimpleLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SimpleLangParser#typed_idfrList}.
	 * @param ctx the parse tree
	 */
	void enterTyped_idfrList(SimpleLangParser.Typed_idfrListContext ctx);
	/**
	 * Exit a parse tree produced by {@link SimpleLangParser#typed_idfrList}.
	 * @param ctx the parse tree
	 */
	void exitTyped_idfrList(SimpleLangParser.Typed_idfrListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code DivBinop}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 */
	void enterDivBinop(SimpleLangParser.DivBinopContext ctx);
	/**
	 * Exit a parse tree produced by the {@code DivBinop}
	 * labeled alternative in {@link SimpleLangParser#binop}.
	 * @param ctx the parse tree
	 */
	void exitDivBinop(SimpleLangParser.DivBinopContext ctx);
}